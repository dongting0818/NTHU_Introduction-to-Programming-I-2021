...
ALLEGRO_SAMPLE* NICE = NULL;
ALLEGRO_SAMPLE* WOW = NULL;
ALLEGRO_FONT* menuFont = NULL;
ALLEGRO_FONT* settingFont = NULL;
int fontSize = 30;
...
void shared_init(void) {
	...
	settingFont = load_font("Assets/Minecraft.ttf", 40);
	...
	NICE = load_audio("Assets/Music/nice.ogg");
	WOW = load_audio("Assets/Music/WOW.ogg");
